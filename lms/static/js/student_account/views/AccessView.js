define([
    ...
    function( Backbone, gettext, $, url, _, _s, utility,
        ...
        return Backbone.View.extend({
            ...
            // Expose the `url()` function so it can be stubbed by the test suite.
            url: url,
                ...
                if ( queryParams.enrollmentAction === 'enroll' && queryParams.courseId) {
                    ...
                    */
                    if ( !_.isNull( queryParams.next ) ) {
                        ...
                        // Note: `window.isExternal()` is defined in the `utility` dependency
                        // TODO: replace this global function with a RequireJS-compatible module.
            ...
            queryParams: function() {
                return {
                    next: this.url( '?next' ),
                    enrollmentAction: this.url( '?enrollment_action' ),
                    courseId: this.url( '?course_id' )
                };
            },
