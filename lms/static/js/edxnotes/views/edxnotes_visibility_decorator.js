;(function (define, undefined) {
    ...
    define(['jquery', 'underscore', 'js/edxnotes/views/notes'], function($, _, Notes) {
        var parameters = {}, visibility = null,
            getIds, createAnnotator, cleanup, factory;
            ...
            factory = function (element, params, vis) {

                // When switching sequentials, we need to keep track of the parameters of each element and the
                // visibility (that may have been changed by the checkbox).
